var grafico05 = {
  ...
  especificacao: (() => {
    ...
    // O retorno do layout concatenado vai para a propriedade 'especificacao'
...
vegaEmbed('#Peso_Regional:_Escolas_Rurais_vs_Urbanas_por_Região', grafico05.especificacao);
